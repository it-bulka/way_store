...
export const CARE_INSTRUCTIONS: Record<MetalsType, string> = {
  ...
  silver:
    'Протирайте срібло спеціальною антиоксидантною тканиною. Уникайте тривалого контакту з вологою і хлором. Зберігайте в герметичній упаковці.',
  platinum:
    "Платина стійка, але може подряпатися. Протирайте м'якою тканиною. При подряпинах зверніться до ювеліра для полірування. Зберігайте окремо.",
  'stainless steel':
    'Не потребує особливого догляду. Промивайте теплою водою з нейтральним милом, насухо витирайте. Стійка до іржі та подряпин.',
}
