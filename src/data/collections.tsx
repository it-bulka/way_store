...
«Вічний силует» не про тренди. Це про рішення, яке залишається правильним через десять років.`,
    gallery: [
      { id: '1', img: '/products/rings/001/white/1.webp', alt: 'WAY — каблучка біле золото', productId: 'ring-001', productCategory: 'rings' },
      { id: '2', img: '/products/necklaces/001/white/1.webp', alt: 'WAY — намисто біле золото', productId: 'necklace-001', productCategory: 'necklaces' },
      { id: '3', img: '/products/earrings/005/white/1.webp', alt: 'WAY — сережки біле золото', productId: 'earring-005', productCategory: 'earrings' },
      { id: '4', img: '/products/rings/002/white/1.webp', alt: 'WAY — каблучка класика', productId: 'ring-002', productCategory: 'rings' },
      { id: '5', img: '/products/bracelets/005/white/1.webp', alt: 'WAY — браслет біле золото', productId: 'bracelet-005', productCategory: 'bracelets' },
    ],
  ...
  },
  {
    ...
    images: [
      '/products/rings/004/rose/1.webp',
      '/products/earrings/001/yellow/1.webp',
    ],
    heroImage: Col3,
...
Усі вироби — ручна робота у київській майстерні WAY.`,
    gallery: [
      { id: '1', img: '/products/rings/004/rose/1.webp', alt: 'WAY — каблучка рожеве золото', productId: 'ring-004', productCategory: 'rings' },
      { id: '2', img: '/products/earrings/001/yellow/1.webp', alt: 'WAY — сережки жовте золото', productId: 'earring-001', productCategory: 'earrings' },
      { id: '3', img: '/products/necklaces/004/yellow/1.webp', alt: 'WAY — намисто жовте золото', productId: 'necklace-004', productCategory: 'necklaces' },
      { id: '4', img: '/products/bracelets/002/yellow/1.webp', alt: 'WAY — браслет золото', productId: 'bracelet-002', productCategory: 'bracelets' },
      { id: '5', img: '/products/rings/016/rose/1.webp', alt: 'WAY — каблучка рожеве золото', productId: 'ring-016', productCategory: 'rings' },
    ],
...
Тираж — обмежений. Замовлення приймаємо до вичерпання кількості.`,
    gallery: [
      { id: '1', img: '/products/rings/001/white/1.webp', alt: 'WAY — каблучка біле золото', productId: 'ring-001', productCategory: 'rings' },
      { id: '2', img: '/products/bracelets/003/white/1.webp', alt: 'WAY — браслет срібло', productId: 'bracelet-003', productCategory: 'bracelets' },
      { id: '3', img: '/products/earrings/001/white/1.webp', alt: 'WAY — сережки біле золото', productId: 'earring-001', productCategory: 'earrings' },
      { id: '4', img: '/products/necklaces/003/white/1.webp', alt: 'WAY — кольє срібло', productId: 'necklace-003', productCategory: 'necklaces' },
      { id: '5', img: '/products/bracelets/004/white/1.webp', alt: 'WAY — браслет біле золото', productId: 'bracelet-004', productCategory: 'bracelets' },
    ],
  ...
  },
  {
    ...
    images: [
      '/products/pendants/001/yellow/1.webp',
      '/products/chains/001/yellow/1.webp',
    ],
    heroImage: Col4,
...
Усі вироби виготовлені в Україні. Доступні для щоденного носіння. Перевірені часом.`,
    gallery: [
      { id: '1', img: '/products/pendants/001/yellow/1.webp', alt: 'WAY — підвіска жовте золото', productId: 'pendant-001', productCategory: 'pendants' },
      { id: '2', img: '/products/chains/001/yellow/1.webp', alt: 'WAY — ланцюжок жовте золото', productId: 'chain-001', productCategory: 'chains' },
      { id: '3', img: '/products/pendants/002/yellow/1.webp', alt: 'WAY — підвіска мінімалізм', productId: 'pendant-002', productCategory: 'pendants' },
      { id: '4', img: '/products/chains/003/yellow/1.webp', alt: 'WAY — ланцюжок золото', productId: 'chain-003', productCategory: 'chains' },
      { id: '5', img: '/products/pendants/006/yellow/1.webp', alt: 'WAY — підвіска золото', productId: 'pendant-006', productCategory: 'pendants' },
    ],
...
Виручений результат: образ, який не треба пояснювати.`,
    gallery: [
      { id: '1', img: '/products/watches/001/white/1.webp', alt: 'WAY — годинник біле золото', productId: 'watch-001', productCategory: 'watches' },
      { id: '2', img: '/products/cufflinks/001/yellow/1.webp', alt: 'WAY — запонки жовте золото', productId: 'cufflink-001', productCategory: 'cufflinks' },
      { id: '3', img: '/products/earrings/010/rose/1.webp', alt: 'WAY — сережки рожеве золото', productId: 'earring-010', productCategory: 'earrings' },
      { id: '4', img: '/products/watches/003/white/1.webp', alt: 'WAY — годинник класика', productId: 'watch-003', productCategory: 'watches' },
      { id: '5', img: '/products/cufflinks/003/white/1.webp', alt: 'WAY — запонки біле золото', productId: 'cufflink-003', productCategory: 'cufflinks' },
    ],
